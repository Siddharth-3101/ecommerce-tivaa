...
export default function Footer() {
    return (
        <footer style={{ background: '#562e74', color: '#EADCF8', paddingTop: '24px', paddingBottom: '16px', borderTop: '1px solid rgba(255, 255, 255, 0.15)' }}>
            <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', marginBottom: '12px', padding: '0 24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                    ...
                    <ul style={{ 
                        ...
                        <li><Link href="/refund-policy" className="footer-link" style={{ fontSize: '0.8rem', letterSpacing: '0.5px' }}>Refund Policy</Link></li>
                        <li><Link href="/terms" className="footer-link" style={{ fontSize: '0.8rem', letterSpacing: '0.5px' }}>Terms of Service</Link></li>
                    </ul>
                </div>
            </div>

            {/* Bottom Part: Socials & Copyright */}
            <div className="container" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.15)', paddingTop: '12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', paddingLeft: '24px', paddingRight: '24px' }}>
                ...
                {/* Copyright text */}
                <p style={{ color: '#CFA7F5', fontSize: '0.75rem', margin: 0, textAlign: 'center', letterSpacing: '0.5px' }}>
