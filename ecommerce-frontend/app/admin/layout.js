            ...
            >
                ...
                <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "4px" }}>
                    {[
                        ...
                        const active = isActive(link.href) || (link.href !== "/admin" && pathname?.startsWith(link.href) && !pathname?.startsWith("/admin/hsn"));
                        return (
                            <li key={link.href}>
                                <Link
                                    href={link.href}
                ...
                <div style={{ marginTop: '20px' }}>
                    <button
                        ...
                        style={{
                            ...
                            padding: "10px 16px",
                            borderRadius: "10px",
                            background: pathname?.startsWith("/admin/hsn") ? "var(--accent-glow)" : "transparent",
                            color: pathname?.startsWith("/admin/hsn") ? "var(--accent)" : "var(--text-main)",
                            border: "none",
                            cursor: "pointer",
                            fontWeight: 600,
                            fontSize: "0.95rem"
