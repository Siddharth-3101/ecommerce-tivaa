            ...
            >
                ...
                <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "4px" }}>
                    {[
                        ...
                        { href: "/admin/coupons", label: "Coupons", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg> },
                        { href: "/admin/settings", label: "Settings", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg> }
                    ].map((link) => {
                        const active = isActive(link.href) || (link.href !== "/admin" && pathname?.startsWith(link.href) && !pathname?.startsWith("/admin/hsn") && !pathname?.startsWith("/admin/gst-state"));
                        return (
                            <li key={link.href}>
                                <Link
                                    href={link.href}
                ...
                <div style={{ marginTop: '20px' }}>
                    <button
                        ...
                        style={{
                            ...
                            padding: "10px 16px",
                            borderRadius: "10px",
                            background: (pathname?.startsWith("/admin/hsn") || pathname?.startsWith("/admin/gst-state")) ? "var(--accent-glow)" : "transparent",
                            color: (pathname?.startsWith("/admin/hsn") || pathname?.startsWith("/admin/gst-state")) ? "var(--accent)" : "var(--text-main)",
                            border: "none",
                            cursor: "pointer",
                            fontWeight: 600,
                            fontSize: "0.95rem"
                    ...
                    >
                        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M21 19c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14"></path><path d="M21 5v14"></path></svg>
                            Masters
                        </div>
                        <svg
                            width="14"
                    ...
                    {isMastersOpen && (
                        <ul style={{ listStyle: "none", padding: "4px 0 0 28px", display: "flex", flexDirection: "column", gap: "4px" }}>
                            <li>
                                <Link
                                    href="/admin/hsn"
                                    style={{
                                        ...
                                        padding: "8px 14px",
                                        borderRadius: "8px",
                                        background: isActive("/admin/hsn") ? "var(--accent-glow)" : "transparent",
                                        color: isActive("/admin/hsn") ? "var(--accent)" : "var(--text-muted)",
                                        fontWeight: isActive("/admin/hsn") ? 600 : 500,
                                        fontSize: "0.9rem",
                                        transition: "all 0.2s"
                                    }}
                                >
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="4" y="4" width="16" height="16" rx="2"></rect><line x1="9" y1="9" x2="15" y2="9"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
                                    HSN
                                </Link>
                            </li>
                            <li>
                                <Link
                                    href="/admin/gst-state"
                                    style={{
                                        display: "flex",
                                        alignItems: "center",
                                        gap: "10px",
                                        padding: "8px 14px",
                                        borderRadius: "8px",
                                        background: isActive("/admin/gst-state") ? "var(--accent-glow)" : "transparent",
                                        color: isActive("/admin/gst-state") ? "var(--accent)" : "var(--text-muted)",
                                        fontWeight: isActive("/admin/gst-state") ? 600 : 500,
                                        fontSize: "0.9rem",
                                        transition: "all 0.2s"
                                    }}
                                >
